...
# 1. Strip out Mobile Size Buttons CSS and JS
content = re.sub(r'/\* Mobile Size Buttons \*/[\s\S]*?</style>', '</style>', content)
...
# 2. Update .mobile-customize-panel
...
# 3. Add JS snippet for Change Location and Size updating
js_mvp = """
<script>
...
"""
content = content.replace('</body>', f'{js_mvp}\n</body>')

# 4. Disable other Styles and update Chalet URL
content = content.replace('data-href="https://demo.shedpro.co/product/chalet/"', 'data-href="../chalet/index.html"')
...
print("Applied MVP fixes successfully!")
