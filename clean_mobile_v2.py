...
# Remove extra empty lines created by previous deletions
content = re.sub(r'\n\s*\n\s*\n+', '\n\n', content)
...
print("Applied full width override for mobile size grid.")
