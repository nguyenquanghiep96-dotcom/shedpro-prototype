...
dummy_data_sizes = 'W3siaGVpZ2h0IjoiNy4zIiwicHJpY2VzIjp7InByaWNlIjoyNTE0NSwibHBfc21hcnQiOjAsImxwX2xhcCI6MCwiYm9hcmRfYmF0dGVuXzE2X3Rlc3QiOjB9LCJyb29mUHJpY2VzIjpbXSwibmFtZSI6IjEyWDI4IiwiY29uZGl0aW9uWm9uZSI6WyI0IiwiMiIsIjEiLCIzIl19XQ=='

if 'value="14x20"' not in content:
    options_area = f"""<option disabled class="ssb-option display-text select size-area" value="14x20" data-option-key="ssb-option-size" data-configurator-type="size" data-price-type="base" data-size-width="14" data-size-depth="20" data-sizes="{dummy_data_sizes}">14x20</option>
<option disabled class="ssb-option display-text select size-area" value="14x24" data-option-key="ssb-option-size" data-configurator-type="size" data-price-type="base" data-size-width="14" data-size-depth="24" data-sizes="{dummy_data_sizes}">14x24</option>
<option disabled class="ssb-option display-text select size-area" value="14x28" data-option-key="ssb-option-size" data-configurator-type="size" data-price-type="base" data-size-width="14" data-size-depth="28" data-sizes="{dummy_data_sizes}">14x28</option>
<option disabled class="ssb-option display-text select size-area" value="16x20" data-option-key="ssb-option-size" data-configurator-type="size" data-price-type="base" data-size-width="16" data-size-depth="20" data-sizes="{dummy_data_sizes}">16x20</option>
<option disabled class="ssb-option display-text select size-area" value="16x24" data-option-key="ssb-option-size" data-configurator-type="size" data-price-type="base" data-size-width="16" data-size-depth="24" data-sizes="{dummy_data_sizes}">16x24</option>
<option disabled class="ssb-option display-text select size-area" value="16x28" data-option-key="ssb-option-size" data-configurator-type="size" data-price-type="base" data-size-width="16" data-size-depth="28" data-sizes="{dummy_data_sizes}">16x28</option>
"""
...
if 'value="8.0"' not in content:
    options_height = """<option disabled class="ssb-option display-text select size-height" data-configurator-type="size-height" data-size-height="8.0" value="8.0" data-option-key="ssb-option-size-height" data-zone-condition="4,2,1,3" data-option-value="8.0">8.0</option>
<option disabled class="ssb-option display-text select size-height" data-configurator-type="size-height" data-size-height="8.5" value="8.5" data-option-key="ssb-option-size-height" data-zone-condition="4,2,1,3" data-option-value="8.5">8.5</option>
<option disabled class="ssb-option display-text select size-height" data-configurator-type="size-height" data-size-height="9.0" value="9.0" data-option-key="ssb-option-size-height" data-zone-condition="4,2,1,3" data-option-value="9.0">9.0</option>
"""
...
print("Applied clean fixes with proper data attributes!")
